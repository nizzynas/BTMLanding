      ...
      {sections.map((section, index) => (
        <div
          ...
          style={{
            ...
            color: section.bgColor === '#305531' ? '#d3dbcd' : '#305531',
          }}
        ...
        >
          ...
          >
            ...
            <div
              style={{
                backgroundColor:
                  section.bgColor === '#305531' ? '#d3dbcd' : '#305531',
            ...
            <h2 className="mb-4 text-5xl font-bold">{section.title}</h2>

            {/* Description with bold subtitles */}
            <p className="mb-6 whitespace-pre-line text-xl">
            ...
            <a
              ...
              className="inline-flex items-center transition-colors hover:text-opacity-80"
            >
              {section.linkText}
              <ChevronRight className="ml-2 transition-transform group-hover:translate-x-2" />
            </a>
          </motion.div>
        </div>
      ))}
